...
const BlogPage = async () => {
  const page = 1
  const posts = (await getPosts(page)) as unknown as {
    docs: CardPost[]
    totalDocs: number
    page: number
    totalPages: number
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted">
              Explora artículos, tutoriales y reflexiones sobre desarrollo web, SEO y tecnología.
            </p>
          </div>
                ...
                <ul className="inline-flex items-center -space-x-px">
                  <li>
                    <a
                      ...
                      href={`/blog/page/${Math.max(1, posts.page - 1)}`}
                    >
                      Anterior
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      ...
                      href={`/blog/page/${Math.min(posts.totalPages, posts.page + 1)}`}
                    >
                      Siguiente
                    </a>
                  </li>
