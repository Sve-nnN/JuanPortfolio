...
export const beforeChangeHook =
  ...
  async ({ data, req, operation, originalDoc }: Parameters<CollectionBeforeChangeHook>[0]) => {
    try {
      console.log('[SEO Plugin] beforeChange hook called', {
        operation,
        hasData: !!data,
      })
      ...
      if (
        ...
        console.log('[SEO Plugin] Running SEO analysis...')
        ...
        console.log('[SEO Plugin] Analysis complete, score:', analysis.score)
      }
